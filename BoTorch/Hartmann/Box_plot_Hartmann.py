...
def scatter_25_and_75_percentile_track_X(Output,n_lhs_samples,total,bs,start,iterations,ground_y_max,beta,std_noise,filename):
    ...
    return indexY,index25,index75,index50_75;
...
def plotting(Output,n_lhs_samples,total,bs,start,iterations,ground_y_max,beta,std_noise,filename):
    ...
    # # X tracking portion
    index50_75=[]
    index_corresponded_Y,percentile25_X_index,percentile75_X_index,index50_75=scatter_25_and_75_percentile_track_X(Output,n_lhs_samples,total,bs,start,iterations,ground_y_max,beta,std_noise,filename)
    
    
    Transition_calculation.second_maxima_locator(Output,n_lhs_samples,total,bs,start,iterations,ground_y_max,beta,std_noise,filename)