...
def parity_plot(X,train_x,model,Y_mean,Y_std,ymin,LHS_no,noise,beta):
    ...
    folder_name='parity_plot'+'_noise'+str(noise)+'_beta_'+str(beta)  
...
def create_subplot_surface(subplot_num, subplot_row,subplot_column, x1, x2, M, X,Xmax1,Xmax2, Xtrue1,Xtrue2,X1true1,X1true2,ymin,LHS_No,noise,bound,index1,index2):
    ...
    ax.plot_surface(X2, X1, M,cmap='viridis')
    ...
    if subplot_column==1 and subplot_row==1:
        plt.tight_layout()
        folder_name='Surface_Maps'+'LHS_No'+str(LHS_No)+'_noise'+str(noise)
        plot_filename='X'+str(index1)+'X'+str(index2)+'bound_'+str(bound)+'.png'
        saveing_in_folder(folder_name,plot_filename)
        plt.close()
...
def predicted_model_perLHS(model_X,model,Y_mean,Y_std,ymin,LHS_No,noise):
    ...
    print('ymax = ',np.max(Y_pred),'\t ymin = ',np.min(Y_pred))
    ...
    for bound in bounds:
        ...
        create_subplot(1, subplot_row,subplot_column,x1, x2, M12, model_X,X1max, X2max, X1true, X2true,X1true1, X2true1,ymin,LHS_No,noise,bound,index1=1,index2=2)
        create_subplot(2, subplot_row,subplot_column,x1, x3, M13, model_X,X1max, X3max, X1true, X3true,X1true1, X3true1,ymin,LHS_No,noise,bound,index1=1,index2=3)
        create_subplot(3, subplot_row,subplot_column,x1, x4, M14, model_X,X1max, X4max, X1true, X4true,X1true1, X4true1,ymin,LHS_No,noise,bound,index1=1,index2=4)
        create_subplot(4, subplot_row,subplot_column,x1, x5, M15, model_X,X1max, X5max, X1true, X5true,X1true1, X5true1,ymin,LHS_No,noise,bound,index1=1,index2=5)
        create_subplot(5, subplot_row,subplot_column,x1, x6, M16, model_X,X1max, X6max, X1true, X6true,X1true1, X6true1,ymin,LHS_No,noise,bound,index1=1,index2=6)
